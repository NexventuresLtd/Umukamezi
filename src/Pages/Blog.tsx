...
import CameraBlogHero from './HeroBlog';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-yellow-50">
      ...
      <div className="max-w-11/12  mx-auto px-4 py-12">
            ...
            >
              ...
              <div className="relative overflow-hidden h-48">
                ...
                <div className="absolute top-3 right-3 flex space-x-2">
                  <button
                    ...
                    className={`p-2 rounded-full -lg transition-all duration-300 ${likedPosts.has(post.id)
              ...
              <div className="p-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r bg-yellow-500 text-white py-3 rounded-xl font-medium hover:from-yellow-600 hover:to-yellow-800 transition-all duration-300 transform hover:scale-105 flex items-center justify-center"
                >
          ...
          <div className="bg-white rounded-3xl -2xl overflow-hidden mb-16 group cursor-pointer">
            <div className="lg:flex">
              <div className="lg:w-1/2 relative overflow-hidden">
                ...
                <div className="h-92 rounded-lg overflow-hidden">

                  <img
                    src={featuredPost.image}
                    alt={featuredPost.title}
                    className="w-full h-full lg:h-full object-cover transform group-hover:scale-105 transition-transform duration-700"
                  />
                </div>
              </div>
              <div className="lg:w-1/2 p-8 lg:p-12">
                <div className="flex items-center mb-4">
                  <span className="bg-gradient-to-r bg-yellow-500 text-white px-3 py-1 rounded-full text-sm font-medium">
                ...
                <button
                  ...
                  className="bg-gradient-to-r bg-yellow-500 text-white px-6 py-3 rounded-xl font-medium hover:from-yellow-600 hover:to-yellow-800 transition-all duration-300 transform hover:scale-105 flex items-center"
                >
                  Read Full Article
        ...
        <div className="bg-gradient-to-r bg-yellow-500 text-white p-12 rounded-3xl text-center -2xl">
